...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-E3EILWRU.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-E3EILWRU.js")).default(client, args);
    case "add":
      return (await import("./add-PABR7UDW.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-2LDHZJ24.js")).default(client, args);
    case "rm":
      return (await import("./rm-ZLDS7FJG.js")).default(client, args);
    case "update":
      return (await import("./update-A3O2FDGF.js")).default(client, args);
    default:
